                ...
                <Collapse in={rewardsOpen} timeout="auto" unmountOnExit>
                  <List component="div" disablePadding>
                    <ListItem className="justify-items text-solacid border-b border-solacid" style={{padding: 1, paddingLeft: 20, paddingRight: 20, paddingTop: 15}}>
                        <ListItemText className="w-2/12" primary={`Epoch`} />
                        <ListItemText className="w-4/12" primary={`Reward`} />
                        <ListItemText className="w-1/12" primary={`APR`} />
                        <ListItemText className="w-1/12" primary={`Fee`} />
                        <ListItemText className="w-4/12 text-right" primary={`Timestamp`} />
                    </ListItem>
                    {stakeAccountMeta.inflationRewards.map(inflationReward => (
                      <ListItem className="justify-items border-b border-solblue-2 dark:border-solblue-darker" style={{padding: 1, paddingLeft: 20, paddingRight: 20}} key={inflationReward.epoch}>
                        <ListItemText className="w-2/12" primary={`${inflationReward.epoch}`} />
                        <ListItemText className="w-4/12" primary={`${inflationReward.amount / LAMPORTS_PER_SOL} SOL`} />
                        <ListItemText className="w-1/12" primary={`0%`} />
                        <ListItemText className="w-1/12" primary={`0%`} />
                        <ListItemText className="w-4/12 text-right" primary={`August 19 2021`} />
                      </ListItem>
                    ))}
                  </List>
                </Collapse>
